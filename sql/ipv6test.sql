...
CREATE TABLE `ipv6_support_degree`  (
  ...
  `connectivity` json NULL COMMENT 'ipv6连通性',
  `secondary_connectivity` json NULL COMMENT '二级链接连通性',
  `tertiary_connectivity` json NULL COMMENT '三级链接连通性',
...
CREATE TABLE `website_information`  (
  ...
  `ipv4_addr` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'ipv4地址',
  `ipv6_addr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'ipv6地址',
